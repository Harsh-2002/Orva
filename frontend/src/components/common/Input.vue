  ...
  <div class="flex flex-col gap-1.5 w-full">
    ...
    <div class="relative">
      ...
      <input
        ...
        :type="type"
        :value="modelValue"
        class="w-full bg-background border border-border rounded-md px-3 py-2 text-base sm:text-sm text-foreground placeholder-foreground-muted focus:outline-none focus:ring-1 focus:ring-focus-ring focus:border-focus-ring transition-colors duration-200"
        :class="{'pl-9': icon}"
