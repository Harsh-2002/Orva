// "System prompt for AI assistants" — paste-ready text that teaches
// any modern LLM (Claude, GPT-4o, Gemini, Cursor, Copilot, …) how to
// write production-grade Orva functions on the first try.
//
// Structure follows Anthropic's published prompt-engineering guidance:
// explicit role assignment, XML-tagged sections so the model can
// reference them, multi-shot examples, and numbered output-format
// rules at the end. The same pattern works across vendors.
//
// When you change Orva's runtime adapters, sandbox limits, or the
// orva SDK kwarg shapes, update this prompt — it's the single source
// of truth users paste into their AI tool.
